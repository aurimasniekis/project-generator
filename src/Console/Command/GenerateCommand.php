...
namespace Tasksuki\Tool\ProjectGenerator\Console\Command;
 ...
 *
 * @package Tasksuki\Tool\ProjectGenerator\Console\Command
...
class GenerateCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $wrapper->cloneRepository('git@github.com:tasksuki/project-template.git', $projectPath);
